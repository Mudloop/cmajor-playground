...
export class Faust2Doc {
     ...
     * @memberof Faust2MD
     */
    static matchFuncName(str: string): string | null {
     ...
     * @memberof Faust2Doc
     */
    static getAllConditions(str: string): string[] | undefined {
     ...
     * @memberof Faust2Doc
     */
    private static getCondition(condsIn?: string[]): string[] | undefined {
     ...
     * @memberof Faust2MD
     */
    static async parse(fileName: string, getFile: (fileName: string) => Promise<string>, depthIn?: number, pathIn?: string[], docIn?: TFaustDocs): Promise<TFaustDocs | undefined> {
