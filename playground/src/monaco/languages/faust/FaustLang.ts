import { languages, editor, Position, Range } from '@cmajor-playground/bunaco/dist';
import { LibFaust } from "@grame/faustwasm";
import { TFaustDocs, TFaustDoc } from "./Faust2Doc";
...
export const matchDocKey = (doc: TFaustDocs, model: editor.ITextModel, position: Position): TMatchedFaustDoc => {
    ...
    if (!wordAtPosition) return null as any;
